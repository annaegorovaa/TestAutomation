...
public class PageObjectWebPageLoginTest {
    ...
    public void testWebPageLogin() {
        ...
        indexPage.checkHomePageHeaderDisplayed(driver);
        indexPage.checkHomePageMainTextDisplayed(driver);
    }
}
